...
export default class Cart extends Component {
  ...
  placeOrder() {
    ...
    fetch(
      `https://shopkart-2411-default-rtdb.firebaseio.com/orders/${this.props.user.id}.json`,
      {
        method: "POST",
      ...
      return (
        <div className="cart">
          ...
          <div className="cart-right">
            ...
            {this.props.user ? (
              <button className="add-btn link" onClick={this.placeOrder}>
                Place Order
              </button>
            ) : (
...
const CartItem = ({ p, updateCart, cartLoading }) => (
